        ...
        <Container>
          <SignUpContainer signingIn={signIn}>
            <Form onSubmit={onSubmit}>
              <h1 className="text-[32px] text-[#ccc] font-bold mb-3">Ro'yxatdan o'tish</h1>
              {error && <div className="error">{JSON.stringify(error)}</div>}
              <div>
                <select className="w-full max-w-[250px] p-3 pr-[20px] mb-4" name="role" id="role">
                  <option value="center">O'quv markaz</option>
                  <option value="student">O'quvchi</option>
                </select>
              </div>
              <div className="flex items-center justify-between w-[100%] max-w-[600px] gap-3">
                <Input value={userInp} onChange={userChange} type="text" placeholder="Ташкилот номи:" />
                <Input value={userInp} onChange={userChange} type="text" placeholder="Фойдаланувчи Ф.И.Ш:" />
              </div>
              <div className="flex items-center justify-between w-[100%] max-w-[600px] gap-3">
                <Input value={userInp} onChange={userChange} type="text" placeholder="Username" />
                <Input value={userInp} onChange={userChange} type="text" placeholder="Телефон рақами:" />
              </div>
              <div className="flex items-center justify-between w-[100%] max-w-[600px] gap-3 mt-3">
                ...
                <select className="w-full max-w-[300px] p-3 pr-[20px]" name="district" id="district">
              ...
              <div className="flex items-center justify-between w-[100%] max-w-[600px] gap-3 mb-3 mt-3">
                <Input value={emailInp} onChange={emailChange} type="email" placeholder="Email" />
                <Input value={passwordInp} onChange={passwordChange} type="password" placeholder="Password" />
              </div>
