...
export const Button = styled.button`
  ...
  background: #1c92d2; /* New color */
  background: -webkit-linear-gradient(to right, #1c92d2, #00c6ff); /* New gradient */
  background: linear-gradient(to right, #1c92d2, #00c6ff); /* New gradient */
  color: #ffffff;
  font-size: 12px;
  font-weight: bold;
  padding: 12px 45px;
